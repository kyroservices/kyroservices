...
function populateCountryDropdown() {
    ...
    if (currentCountryValue) {
        countrySelect.value = currentCountryValue;
         ...
         updateCityDropdown(); // İlk yüklemede şehirleri doldur
    }
}
